...
/* package comp-to-assembly-from-scratch-hs-0.1.0.0 */
#ifndef VERSION_comp_to_assembly_from_scratch_hs
#define VERSION_comp_to_assembly_from_scratch_hs "0.1.0.0"
#endif /* VERSION_comp_to_assembly_from_scratch_hs */
#ifndef MIN_VERSION_comp_to_assembly_from_scratch_hs
#define MIN_VERSION_comp_to_assembly_from_scratch_hs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_comp_to_assembly_from_scratch_hs */
...
#define CURRENT_PACKAGE_KEY "comp-to-assembly-from-scratch-hs-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "comp-to-assembly-from-scratch-hs-0.1.0.0-inplace"
